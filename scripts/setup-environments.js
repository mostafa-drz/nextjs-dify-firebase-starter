...
function checkVercelCLI() {
  ...
  try {
    ...
    try {
      ...
      console.error('Error checking Vercel login:', error);
      console.log('❌ Not logged in to Vercel');
      console.log('   Run: vercel login');
    }
  } catch (error) {
    console.error('Error checking Vercel CLI:', error);
...
function checkFirebaseCLI() {
  ...
  try {
    ...
    try {
      ...
      console.error('Error checking Firebase projects:', error);
      console.log('❌ Firebase CLI not authenticated');
      console.log('   Run: firebase login');
    }
  } catch (error) {
    console.error('Error checking Firebase CLI:', error);
...
function generateEnvironmentSetup() {
  ...
  Object.entries(environments).forEach(([, config]) => {
